...
//        props.put("mail.smtp.port", "587");
        ...
        try {
            ...
            for (int i = 0; i < messages.length; i++) {
                if (messages[i].getSubject()
                        .toLowerCase().contains(subject.toLowerCase())) {
    ...
    public void waitNewMailBySubject(String folderName, String subject, int timeout) throws MessagingException, InterruptedException {
        ...
        try {
            ...
            for (int j = 0; j < timeout; j++) {
                if (messages.length > 0 && messages[j].getSubject().equalsIgnoreCase(subject))
                    break;
    ...
    private Properties setProperties() {
        ...
        } else if (protocal.equalsIgnoreCase("gg")) {
            props.setProperty("mail.store.protocol", "pop3s");
            props.setProperty("mail.pop3s.host", "995");
    ...
    public static void main(String[] args) throws MessagingException, InterruptedException {
        Email email = new Email("imaps", "imap.gmail.com", "loitq147@gmail.com", "P@ssw0rd114@");
        System.out.println(email.getMailBody("Inbox", "Nguyễn Kim: Khôi phục mật khẩu"));
        email.deleteMailBySubject("Inbox", "Nguyễn Kim: Khôi phục mật khẩu");
    }
