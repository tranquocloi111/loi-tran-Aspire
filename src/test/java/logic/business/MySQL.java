...
import framework.util.Db;
import framework.util.Email;
...
public class MySQL extends Db {
    ...
    public static List executeQueryReturnList(String query) {
        try {
    ...
    public static ResultSet executeQueryReturnResult(String query) {
        return Db.executeQuery(createConnection(), query);
    }
    ...
    public List<String> executeQueryReturnListString(String query) {
        ...
        sms = MySQL.getMySqlInstance().executeQueryReturnList(query);
    ...
    public ResultSet executeQueryReturnResultSet(String query) {
        return MySQL.getMySqlInstance().executeQuery(query);
    }
